...
module.exports = {
    ...
    execute: async (interaction) => {
        ...
        try {
            ...
            const allItems = destr(fs.readFileSync(path.join(__dirname, "../../../Config/DefaultProfiles/allchaos.json"), 'utf8'));
            if (!allItems) {
                return interaction.editReply({ content: "failed to parse allchaos.json" });
            }
